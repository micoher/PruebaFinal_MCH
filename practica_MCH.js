    ...
    function (Map,Locator,AddressCandidate, SimpleMarkerSymbol,Font,TextSymbol, Graphic, FeatureLayer, Extent, ServiceAreaTask, ServiceAreaParameters, FeatureSet, SimpleFillSymbol, SimpleLineSymbol, Point, Query,
        ...
        BorderContainer, ContentPane) {
                ready(function(){
                    ...
                    var centrosSalud = new FeatureLayer("https://services5.arcgis.com/zZdalPw2d0tQx8G1/ArcGIS/rest/services/CENTROS_SALUD_MCH/FeatureServer/0",{
                            outFields:["*"],
                        });
                        
                        
                        var featureSet = new FeatureSet();
                        var query = new Query(centrosSalud);
                    ...
                    centrosSalud.on("selection-complete", añadir);

                    function añadir(select){
                        var features = []
                        
                        featureSet.features = select.features;
